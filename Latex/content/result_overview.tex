...
\begin{figure}[htbp]	
	\begin{center}
	\includesvg[width=0.7\textwidth]{figures/subjects}
...
\begin{figure}[htbp]	
	\begin{center}
	\includesvg[width=0.7\textwidth]{figures/AR_technology}
	\captionsetup{font=small}
...
\begin{figure}[htbp]	
	\begin{center}
	\includesvg[width=0.7\textwidth]{figures/Hardware_supported}
	\captionsetup{font=small}
...
\begin{figure}[htbp]	
	\begin{center}
	\includesvg[width=0.7\textwidth]{figures/Software_used}
	\captionsetup{font=small}
